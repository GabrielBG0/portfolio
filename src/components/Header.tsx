...
const StarSVG = ({ className, ...props }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
  <svg className={className} viewBox="0 0 74 86" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
