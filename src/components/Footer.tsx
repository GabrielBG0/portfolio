const StarSVG = () => (
  <svg style={{ height: "18px", width: "auto" }} viewBox="0 0 74 86" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  return (
    <footer>
      <div className="footer-inner">
        ...
        <div className="footer-mid">Gabriel Gutierrez — PhD Candidate, Unicamp</div>
        <div className="footer-right">Weakly Supervised Learning · Open Source</div>
      </div>
    </footer>
  );
}
